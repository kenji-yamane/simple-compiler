...
static const char *const yytname[] =
{
  ...
  "IF", "WHILE", "INT", "RETURN", "VOID", "ID", "NUM", "SEMI", "COMMA",
  "LPAREN", "RPAREN", "LBRACK", "RBRACK", "LBRACE", "RBRACE", "PLUS",
  "MINUS", "TIMES", "OVER", "LT", "LTEQ", "GTEQ", "EQ", "NEQ", "GT",
  "ASSIGN", "LOWER_THAN_ELSE", "ELSE", "$accept", "programa", "decl_lista",
  "decl", "var_decl", "$@1", "$@2", "$@3", "tipo", "fun_decl", "$@4",
  "params", "params_seq", "param", "$@5", "comp_decl", "local_decl",
  "stmt_lista", "stmt", "expr_decl", "selc_decl", "iter_decl", "retr_decl",
  "exp", "var", "$@6", "smp_exp", "rel", "soma_exp", "soma", "termo",
  "mult", "fator", "ativacao", "$@7", "args", "arg_lista", YY_NULLPTR
};
